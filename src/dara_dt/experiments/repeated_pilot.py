...
def run_repeated_pilot(
    ...
    no_assurance_outcomes: list[OutcomeResult] = []
    global_divergence_outcomes: list[OutcomeResult] = []
    dara_dt_outcomes: list[OutcomeResult] = []
    ...
    for _ in range(repetitions):
        ...
        for condition in (
            ...
            no_assurance_outcomes.append(
                condition.policy_results.no_assurance
            )

            global_divergence_outcomes.append(
                condition.policy_results.global_divergence
            )

            dara_dt_outcomes.append(
                condition.policy_results.dara_dt
            )
